            ...
            <div className="col-md-6 col-lg-5">
              <div className="card border-0 shadow-sm p-4 text-center">
                ...
                <p className="text-secondary mb-4">
                  Unfortunately, your payment could not be processed at this
                  time. Please check your card details and try again.
                </p>
                ...
                <div className="bg-danger bg-opacity-10 rounded p-3 mb-4 text-start border border-danger border-opacity-25">
                  ...
                  <p className="text-danger small mb-0">
                    Your bank declined the transaction. This can happen if the
                    card is expired, has insufficient funds, or has incorrect
                    CVV.
                  </p>
                </div>
