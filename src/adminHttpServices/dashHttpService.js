  ...
  try {
    ...
    if (!data?.error) {
      Swal.fire({
        ...
        icon: "success",
        position: "top-end",
        title: "Local deleted successfully",
        showConfirmButton: false,
        timerProgressBar: true,
        timer: 3000,
      });
...
// REFUND
export async function GetAllRefundList(formData, signal) {
  try {
    const { data } = await adminHttpService.put(
      `${process.env.REACT_APP_API}/api/admin/refundList`,
      formData,
      signal,
    );
...
export async function GetAllRefundDetails(id) {
  try {
    const { data } = await adminHttpService.get(
      `${process.env.REACT_APP_API}/api/admin/refundDetails/${id}`,
    );
...
export async function AddCity(formData) {
  try {
    const { data } = await adminHttpService.post(
      `${process.env.REACT_APP_API}/api/guide/addPopularCity`,
      formData,
    );
...
export async function UpdateCity(formData, id) {
  try {
    const { data } = await adminHttpService.put(
      `${process.env.REACT_APP_API}/api/guide/updatePopularCityImage/${id}`,
      formData,
    );
...
export async function DeleteCity(id) {
  try {
    const { data } = await adminHttpService.delete(
      `${process.env.REACT_APP_API}/api/guide/deleteCity/${id}`,
    );
...
export async function CityStatusCity(id) {
  try {
    const { data } = await adminHttpService.put(
      `${process.env.REACT_APP_API}/api/guide/changeCityStatus/${id}`,
    );
...
export async function PayoutListApi(formData) {
  try {
    const { data } = await adminHttpService.put(
      `${process.env.REACT_APP_API}/api/admin/localPayoutList`,
      formData,
    );
